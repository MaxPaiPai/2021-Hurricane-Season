...
def setplot(plotdata=None):
    ...
    regions = {"Gulf": {"xlimits": (clawdata.lower[0], clawdata.upper[0]),
                        ...
                        "figsize": (6.4, 4.8)},
               "Mississippi River Delta": {"xlimits": (-94.8, -86.3),
                               "ylimits": (28.0, 30.7),
                               "figsize": (8, 2.5)},
                "Grand Isle": {"xlimits": (-90.4, -89.0),
                               "ylimits": (28.8, 29.5),
                               "figsize": (6, 2.7)}} 
    ...
    def gauge_afteraxes(cd): # TO DO: how to plot, what is cd, where is data being read in?
        ...
        tf = datetime.datetime(2021, 8, 30, 17)
        ...
        axes.set_yticks([-1, -.5, 0, .5, 1, 1.5, 2.0, 2.5, 3.0])
        axes.set_yticklabels([r"$-1$", r"$-.5$", r"$0$", r"$.5$", r"$1$", r"$1.5$", r"$2.0$", r"$2.5$", r"$3.0$"])
        axes.grid(True)
    ...
    plotaxes.scaled = True
    plotaxes.xlimits = [-92.8, -86.3]
    plotaxes.ylimits = [28.5, 30.7]
