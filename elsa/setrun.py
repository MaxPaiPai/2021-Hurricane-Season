# Validation for Hurricane Elsa by Max Zhao
"""
...
def setrun(claw_pkg='geoclaw'):
    ...
    amrdata.refinement_ratios_x = [2, 2, 2, 3, 4, 4, 4, ]
    amrdata.refinement_ratios_y = [2, 2, 2, 3, 4, 4, 4, ]
    amrdata.refinement_ratios_t = [2, 2, 2, 3, 4, 4, 4, ]
    ...
    regions.append([3, 5, clawdata.t0, clawdata.tfinal, -84, -82.5, 28, 30.5]) # Cedar Key
    regions.append([3, 5, clawdata.t0, clawdata.tfinal, -84.47, -82.38, 29.4,30.17]) # Apalachee Bay
    regions.append([5, 6, clawdata.t0, clawdata.tfinal, -82.89, -82.38, 27.49, 28.04]) # Tampa Bay
    

    regions.append([4, 5, clawdata.t0, clawdata.tfinal, -83.2, -82.8, 29, 29.3]) # Gauge 1
    regions.append([4, 5, clawdata.t0, clawdata.tfinal, -83.1, -82.7, 27.85, 28.15]) # Gauge 2
    regions.append([4, 5, clawdata.t0, clawdata.tfinal, -83.0, -82.0, 27.0, 28.20]) # Gauge 3
    regions.append([4, 5, clawdata.t0, clawdata.tfinal, -83.0, -82.0, 27.0, 28.20]) # Gauge 4
    regions.append([4, 5, clawdata.t0, clawdata.tfinal, -82.05, -81.75, 26, 26.3]) # Gauge 5
    regions.append([5, 6, clawdata.t0, clawdata.tfinal, -82.0, -81.4, 24.2, 24.8]) # Gauge 6
    ...
    topo_file = topo_file.crop(( -91, -79, 22.5, 31.5))
    ...
    rundata.gaugedata.gauges.append([1, -83.05, 29.08,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])   # CDRF1 Cedar Key 8727520                           
    rundata.gaugedata.gauges.append([2, -82.93, 27.98,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])   # CWBF1 Clearwater Beach 8726724
    rundata.gaugedata.gauges.append([3, -82.57, 27.85,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])   # Old Port Tampa 8726607 
    rundata.gaugedata.gauges.append([4, -82.57, 27.65,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])   # Port Manatee 8726384                      
    rundata.gaugedata.gauges.append([5,-81.82, 26.13,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])   # NPSF1 Naples 8725110
    rundata.gaugedata.gauges.append([6, -81.804, 24.658,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])   # KYWF1 Key West 8724580 
...
def setgeo(rundata):
    ...
    atcf_path = os.path.join(scratch_dir, "bal052021.dat")
